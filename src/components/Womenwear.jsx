...
const Womenwear = () => {
     const { women } = useContext(Storedata)
  ...
  return (
        <div className='mt-10 px-5'>
            <p className='text-xl md:text-4xl font-medium my-5'>Women's Activewear</p>
            <div className='flex justify-evenly flex-wrap'>
                {women.map((items) => {
                    return (
                        <div className='mb-3' key={items.id} data-aos="zoom-out">
